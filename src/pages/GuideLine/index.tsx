				...
				{language === "vi" ? (
					<div>
						...
						<ol type="I" start={2}>
							<li>
								<b>
									Xử lí các điểm dữ liệu cơ bản – Chuẩn hoá dữ
									liệu và số
								</b>
							</li>
						</ol>
						...
						<p className="western">
							Đối với các câu hỏi dạng Có/ Không và câu hỏi lựa
							chọn đáp án, mỗi câu trả lời sẽ được chuẩn hoá theo
							thang điểm từ 0 đến 10.{" "}
							<b>
								Phương pháp chuẩn hoá sẽ được giống nhau đối với
								cả câu hỏi có tính tích cực và tính tiêu cực
							</b>
							, khi đến bước tính điểm sẽ dựa vào tính chất câu
							hỏi để xếp hạng.
						</p>
						<ol start={2}>
							<li>
						...
						<p>
							Xếp hạng phần trăm tương đối chỉ được áp dụng nếu
							một công ty báo cáo một điểm dữ liệu bằng số, trong
							khi tất cả các công ty trong một nhóm ngành đều báo
							cáo điểm dữ liệu tương ứng đó.{" "}
							<b>
								Mỗi thước đo có một cực tính cho biết giá trị
								cao hơn là tích cực hay tiêu cực.
							</b>
						</p>
						<ol type="I" start={3}>
							<li>
						...
						<p>
							Trọng số của từng trụ cột bằng tổng trọng số các chỉ
							số trong trụ cột đó
						</p>
						<p>
						...
						<p>
							<b>Cách 2:</b> Tổng điểm của 3 trụ cột nhân trọng số
							tương ứng
						</p>
						<p>
					...
					<div>
						<h1 style={{ textAlign: "center" }}>
							<b>GUIDELINE: ESG SCORE CALCULATION METHODOLOGY</b>
						</h1>
						<ol type="I">
							<li>
						...
						<ul>
							<li>
								How many companies are worse than the current
								one?
							</li>
						...
						<ol type="I" start={2}>
							<li>
								<b>
									Treatment of underlying data points – Data
									Standardization and numeric
								</b>
							</li>
						</ol>
						<ol>
						...
						<p>
							...
							answer will be standardized on a scale from 0 to 10.{" "}
							<b>
								The standardization method will be the same for
								both positive and negative questions
							</b>
						...
						<p>
							A relative percentile ranking is only applied if a
							numeric data point is reported by a company, while
							all companies in an industry group report that
							respective data point.{" "}
							<b>
								Each measure has a polarity indicating whether a
								higher value is positive or negative.
							</b>
						</p>
						<ol type="I" start={3}>
							<li>
								<b>
									Steps to calculate points for each pillar:
								</b>
							</li>
						</ol>
						<p>
						...
						<p>
							<b>Step 2:</b> Calculate the weight of each pillar
						</p>
						<p>
						...
						<p>
							<b>Method 1:</b> Sum all the indices and multiply
						...
						<p>
							<b>Method 2:</b> Sum the scores of the 3 pillars and
